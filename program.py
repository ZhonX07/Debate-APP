...
from PyQt5.QtCore import (Qt, QTimer, QSize, QTime, pyqtSignal, pyqtSlot, QPropertyAnimation, 
                        ...
                        QParallelAnimationGroup, QRectF, QAbstractAnimation)
from PyQt5.QtGui import QFont, QKeyEvent, QPalette, QColor, QPainter, QPen, QLinearGradient, QPixmap, QBrush

import logging
from logging.handlers import RotatingFileHandler
import ctypes  # 添加ctypes库用于Windows API调用

# 首先初始化 logger 变量，以防止未定义错误
